...
class _HomePageState extends State<HomePage> {
  ...
  @override
  void initState() {
    // if there is no current habbit list , then it is the 1st time ever opening the app
    // create the default data
    if (_myBox.get("CURRENT_HABIT_LIST") == null) {
      db.createDefaultData();
    }

    // this already exsist data , this is not the first time
    else {
      db.loadData();
    }
  ...
  // save exsisting habit with new name**
